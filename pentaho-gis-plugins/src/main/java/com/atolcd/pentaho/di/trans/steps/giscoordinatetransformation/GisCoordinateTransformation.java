...
import com.atolcd.pentaho.di.utils.CoordinateTransformer;
    ...
    public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
        ...
        if (first) {
            ...
            data.geometryFieldIndex = getInputRowMeta().indexOfValue(meta.getGeometryFieldName()); // Récupération
                                                                                              ...
                                                                                              // la
                                                                                              // geométrie
            data.geometryValueMeta = inputRowMeta.getValueMeta( data.geometryFieldIndex );
        ...
        Geometry inGeometry = ((GeometryInterface) data.geometryValueMeta).getGeometry( r[data.geometryFieldIndex] );
            ...
            if (meta.isCrsFromGeometry()) {
                ...
                if (!GeometryUtils.isNullOrEmptyGeometry(inGeometry)) {
                    ...
                    if (inGeometry.getSRID() > 0) {
                        ...
                        data.transformation = getTransformation("EPSG:" + inGeometry.getSRID(), meta.getOutputCRSAuthority() + ":" + environmentSubstitute(meta.getOutputCRSCode()));
